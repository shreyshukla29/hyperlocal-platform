...
> = {
  ...
  meta: {
    modelProps: 'identity' | 'identityVerification';
    ...
    IdentityVerification: {
      ...
      operations: {
        ...
        count: {
          ...
          result:
            | runtime.Types.Utils.Optional<Prisma.IdentityVerificationCountAggregateOutputType>
            | number;
        };
      };
    };
...
export type IdentityVerificationScalarFieldEnum =
  (typeof IdentityVerificationScalarFieldEnum)[keyof typeof IdentityVerificationScalarFieldEnum];
 ...
 * Reference to a field of type 'VerificationType[]'
 */
export type ListEnumVerificationTypeFieldRefInput<$PrismaModel> = FieldRefInputType<
  $PrismaModel,
  'VerificationType[]'
>;
